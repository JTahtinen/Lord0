	...
	namespace math {
		...
		Vec4 Matrix4f::mul(const Vec4& other) const
		{
			...
			/*return Vec4{
				...
				get(1, 0) * other.x + get(1, 1) * other.y + get(2, 2) * other.z + get(3, 3) * other.w,
				get(2, 0) * other.x + get(1, 1) * other.y + get(2, 2) * other.z + get(3, 3) * other.w,
				get(3, 0) * other.x + get(1, 1) * other.y + get(2, 2) * other.z + get(3, 3) * other.w
			};*/
		}

		Vec3 Matrix4f::mul(const Vec3& other) const
		{
			return Vec3(
				get(0, 0) * other.x + get(1, 0) * other.y + get(2, 0) * other.z + get(3, 0),
				get(0, 1) * other.x + get(1, 1) * other.y + get(2, 1) * other.z + get(3, 1),
				get(0, 2) * other.x + get(1, 2) * other.y + get(2, 2) * other.z + get(3, 2)
			);

			/*return Vec3{
				get(0, 0) * other.x + get(0, 1) * other.y + get(0, 2) * other.z + get(0, 3),
				get(1, 0) * other.x + get(1, 1) * other.y + get(2, 2) * other.z + get(3, 3),
				get(2, 0) * other.x + get(1, 1) * other.y + get(2, 2) * other.z + get(3, 3)
			};*/
		}
		...
		Vec3 Matrix4f::operator*(const Vec3& other) const
		{
			return mul(other);
		}
	}
